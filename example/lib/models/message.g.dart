...
const MessageSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'isIncoming': IndexSchema(
      id: -783847435490851269,
      name: r'isIncoming',
      unique: false,
      replace: false,
      properties: [
...
void _messageSerialize(
  ...
  writer.writeLong(offsets[0], object.contactId);
  writer.writeBool(offsets[1], object.isIncoming);
  writer.writeString(offsets[2], object.photo);
...
Message _messageDeserialize(
  ...
  final object = Message(
    contactId: reader.readLong(offsets[0]),
    isIncoming: reader.readBoolOrNull(offsets[1]) ?? true,
    photo: reader.readStringOrNull(offsets[2]),
...
extension MessageQueryWhereSort on QueryBuilder<Message, Message, QWhere> {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anyContactId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhere> anyIsIncoming() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'isIncoming'),
      );
    });
  }
...
extension MessageQueryWhere on QueryBuilder<Message, Message, QWhereClause> {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> contactIdEqualTo(
      int contactId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> contactIdNotEqualTo(
      int contactId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> contactIdGreaterThan(
    int contactId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> contactIdLessThan(
    int contactId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> contactIdBetween(
    int lowerContactId,
    int upperContactId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> isIncomingEqualTo(
      bool isIncoming) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'isIncoming',
        value: [isIncoming],
      ));
    });
  }

  QueryBuilder<Message, Message, QAfterWhereClause> isIncomingNotEqualTo(
      bool isIncoming) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> photoIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'photo',
        value: [null],
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> photoIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'photo',
        lower: [null],
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> photoEqualTo(
      String? photo) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'photo',
  ...
  QueryBuilder<Message, Message, QAfterWhereClause> photoNotEqualTo(
      String? photo) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> isIncomingEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoEqualTo(
    String? value, {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'photo',
        value: '',
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> photoIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'photo',
        value: '',
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> sortByIsIncoming() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isIncoming', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByIsIncomingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isIncoming', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByPhoto() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByPhotoDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQuerySortThenBy
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByIsIncoming() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isIncoming', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByIsIncomingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isIncoming', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByPhoto() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByPhotoDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByIsIncoming() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isIncoming');
    });
  }

  QueryBuilder<Message, Message, QDistinct> distinctByPhoto(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, int, QQueryOperations> contactIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'contactId');
    });
  }

  QueryBuilder<Message, bool, QQueryOperations> isIncomingProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isIncoming');
    });
  }

  QueryBuilder<Message, String?, QQueryOperations> photoProperty() {
    return QueryBuilder.apply(this, (query) {
